    ...
    <main>
      ...
      <section id="om-favourites" ref={favouritesRef} className="om-favourites-section">
        ...
        <div className="favourites-board"><div aria-hidden="true" className="favourites-parallax-trace" />
          ...
          <div className="favourites-sticker-sheet"><motion.img className="home-parallax-image" style={reduceMotion ? {} : { y: stickerY }} src="/assets/om-field-station-stickers.webp" alt="Om’s six field-station research motifs" /><span>OM’S FIELD TOOLS<br />06 MOTIFS / ACTIVE</span></div>
